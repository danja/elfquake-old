...
SobolQRNG: sobol.o sobol_gold.o sobol_gpu.o sobol_primitives.o
...
clean:
	rm -f SobolQRNG sobol.o sobol_gold.o sobol_gpu.o sobol_primitives.o
	rm -rf ../../bin/$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)/SobolQRNG
